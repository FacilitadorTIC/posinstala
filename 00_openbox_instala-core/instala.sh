#!/bin/bash
# ACTION: Instala Openbox WM + herramientas y configuraciones 
# INFO: Openbox es un manejador de ventanas liviano pero necesita de herramientas y configuraciones
# DEFAULT: y
...
# Check root
[ "$(id -u)" -ne 0 ] && { echo "Debe ejecutarse como root" 1>&2; exit 1; }
